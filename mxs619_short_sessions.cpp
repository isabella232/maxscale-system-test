/**
 * @file mxs619_short_session.cpp MXS-619 regression case ("creating many short sessions in parallel leads to errors")
...
void *query_thread1(void *ptr)
{
    ...
    while (data->exit_flag == 0)
    {
        ...
        if (data->conn1 != NULL)
        {
            ...
            {
                //printf("*");
                execute_query(data->conn1, (char *) "SELECT 1");
            }
        }
        if (data->rwsplit_only == 0)
        {
            ...
            if (data->conn2 != NULL)
            {
                ...
                {
                    execute_query(data->conn2, (char *) "SELECT 1");
                }
            }
            ...
            if (data->conn3 != NULL)
            {
                ...
                {
                    execute_query(data->conn3, (char *) "SELECT 1");
                }
            }
        }
